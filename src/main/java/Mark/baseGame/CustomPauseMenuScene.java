...
public class CustomPauseMenuScene extends FXGLMenu
{
    ...
    public CustomPauseMenuScene()
    {
        ...
        gameTitle.setText(Settings.getWindowTitle());
        ...
        app.serverOnlineProperty().addListener((obs, oldVal, isOnline) -> {Color currentColor = isOnline ? Settings.getColorServerOnline() : Settings.getColorServerOffline();statusIndicator.setFill(currentColor);gameVersion.setFill(currentColor);});
        ...
        btnLang.textProperty().bind(FXGL.localizedStringProperty(Settings.getLangKeyMenuLanguage()).concat(": ").concat(FXGL.getLocalizationService().selectedLanguageProperty().asString()));
        ...
        Runnable updateModeText = () ->
        {
            ...
            {
                case WINDOWED: modeI18nKey = Settings.getLangKeyMenuWindowed(); break;
                case BORDERLESS: modeI18nKey = Settings.getLangKeyMenuBorderless(); break;
                case FULLSCREEN: modeI18nKey = Settings.getLangKeyMenuFullscreen(); break;
            }
    ...
    private HBox createKeybindRow(String langKey, String actionName, String defaultKeyName)
    {
        ...
        Button btnKey = new Button(currentKey);
            ...
            EventHandler<KeyEvent> keyListener = new EventHandler<>() {
                ...
                public void handle(KeyEvent event) {
                    ...
                    if (newKey == KeyCode.ESCAPE) {
                        btnKey.setText(prefs.get(Settings.getPrefsKeyBindingPrefix() + actionName, defaultKeyName));
